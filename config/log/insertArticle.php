...
if (
    ...
    && isset($_POST['auteur']) && isset($_POST['rubrik'])
    ...
    // Requête d'insertion
    $query = "INSERT INTO news (titre, abstract, auteur, rubrik, image, date_creation)
            VALUES (:titre, :abstract, :auteur, :rubrik, :image, :date_creation)";
