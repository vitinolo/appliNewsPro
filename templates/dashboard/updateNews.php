...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlUpdateNews = "UPDATE news SET titre = :titre, abstract = :abstract, rubrik = :rubrik WHERE id = :id";
...
<div class="container ">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <textarea type="text" class="form-control-sm mb-2 d-flex flex-column" name="titre" value= $news.titre  id="title" minlength="4" maxlength="200" required></textarea>
            <!--abstract-->
            <label for="article">Abstract</label>
            <textarea type="text" class="form-control-sm mb-2 d-flex flex-column" name="abstract" id="abstract" minlength="4" maxlength="400" required></textarea>
            <!--auteur-->
            <label for="auteur">Auteur</label>
            <input type="text" class="form-control-sm mb-2 d-flex flex-column" name="auteur" id="auteur" minlength="2" maxlength="50" required></input>
            <!--rubrik-->
            ...
            <!---------submit--------->
            <input aria-label="ajouter un article" type="submit" id="ajouter" class="btn btn-success" name="ajouter" value="Modifier">
            <!--bouton annuler-->
            <a href="getAllNews.php" aria-label="annuler" type="button" id="ajouter" class="btn btn-success mt-2" tile="retour vers dashboard" name="annuler" value="Annuler">Annuler</a>
            </form>
        </div>
        <div class="col-md-4"></div>
